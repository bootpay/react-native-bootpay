...
- (BOOL)webView:(BPCWebView *_Nonnull)webView
...
- (void)reload;
- (void)stopLoading;
- (void)navigationOriginRN:(WKWebView *)webView decidePolicyForNavigationAction:(WKNavigationAction *)navigationAction decisionHandler:(void (^)(WKNavigationActionPolicy))decisionHandler;
#if !TARGET_OS_OSX
